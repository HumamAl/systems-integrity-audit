...
const navItems = [
  ...
  { href: "/sync-monitor", label: "Sync Monitor", icon: RefreshCw },
  { href: "/source-of-truth", label: "Source of Truth", icon: Database },
  { href: "/drift-detection", label: "Drift Detection", icon: AlertTriangle },
...
function SidebarLogo({ collapsed }: { collapsed: boolean }) {
  return (
    <div className="p-4 border-b border-border/60 flex items-center gap-3">
      {/* ShieldCheck icon — systems integrity / audit domain */}
